...

{
    ...
    if (argc != 3) {
        ...
        cout << "Usage: programme name <encryptedfile.txt>  <decryptedfile.txt> " << endl;
    ...
    //string inputFile = "C:/Users/s.diallo/OneDrive - Talend/12_Code/!assignment/inputfile.txt";  ///will be changed based on CLA argv

    //string outputFile = "C:/Users/s.diallo/OneDrive - Talend/12_Code/!assignment/outputfile.txt";  ///will be changed based on CLA argv
   ...
   print_vector(arrayout); /// prints the vector of characters returned by the read file function
	...
	writemyFile.flush();
        ...
        // Public members contain data members (variables) and member functions (class methods) of a class.
            ...
            cout << " Do you want to use the suggested key to decrypt ? (1) : " << endl;
           ...
           cout << std::flush;//flush the data in the file each time before decrypting again using a different keyut
